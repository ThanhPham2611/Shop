          ...
          <Form form={form} layout='vertical' onFinish={handleLogin}>
            <Form.Item
              ...
              rules={
                [
                  {
                    required: true, message: 'Bạn cần điền trường này'
                  }
                ]
              }>
            ...
            <Row justify='center' align='bottom' className={styles.linkRegister}>
              <span>Bạn mới biết đến PT Mall, <a>Đăng ký</a></span>
            </Row>
          </Form>
        </div>
      </div>
