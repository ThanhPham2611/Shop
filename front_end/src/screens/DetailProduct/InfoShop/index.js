  ...
  return (
    <Row className={styles.wrapperInfoShop} align="middle">
      <Col className={styles.colAvatar}>
        <Avatar
          size={80}
          src={infoShop?.shopInfo.avatarShop}
          style={{ border: "1px solid #ccc" }}
        />
        {infoShop?.shopInfo.shopMall && (
      ...
      <Col className={styles.colAction}>
        ...
        {infoShop?.userInfo.status ? (
          ...
          <h5 className={styles.textActive}>{`Online ${moment(
            infoShop?.userInfo?.lastLogin
          ).fromNow()}`}</h5>
        )}
        ...
        <Space className={styles.wrapperButton}>
          <ButtonSecond
            ...
            icon={<BsChatRightDotsFill size={13} style={{ marginRight: 10 }} />}
            title={"Chat ngay"}
      ...
      <Col xxl={4} className={styles.colDescription}>
        <Row className={styles.wrapperDescription} justify="space-between">
          ...
          <span className={styles.value}>
            {formatAmoutProductSold(infoShop?.rateInfo)}
          </span>
        </Row>
        <Row className={styles.wrapperDescription} justify="space-between">
      ...
      <Col xxl={5} className={styles.colDescription}>
        <Row className={styles.wrapperDescription} justify="space-between">
          ...
          <span className={styles.value}>
            {moment(infoShop?.shopInfo?.createdAt).fromNow()}
          </span>
        </Row>
        <Row className={styles.wrapperDescription} justify="space-between">
